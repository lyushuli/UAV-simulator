...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /home/rfly/UAV-simulator/src/rotors_simulator/rotors_evaluation)
  set(rotors_evaluation_DEVEL_PREFIX /home/rfly/UAV-simulator/devel/.private/rotors_evaluation)
  ...
  set(rotors_evaluation_INSTALL_PREFIX /home/rfly/UAV-simulator/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rfly/UAV-simulator/src/rotors_simulator/rotors_evaluation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rfly/UAV-simulator/devel/.private/rotors_evaluation/lib;/home/rfly/UAV-simulator/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rotors_evaluation_EXPORTED_TARGETS ${${rotors_evaluation_dep}_EXPORTED_TARGETS})
endforeach()
